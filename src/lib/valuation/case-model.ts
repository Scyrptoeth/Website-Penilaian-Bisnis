...
import { formatInputNumber, formatRateInputNumber } from "./format";
...
export function buildSampleAssumptions(): AssumptionState {
  return {
    taxRate: formatRateInputNumber(sampleCase.taxRate),
    taxRateSource: "statutory-general",
    taxRateOverrideReason: "",
    terminalGrowth: formatRateInputNumber(sampleCase.terminalGrowth),
    terminalGrowthSource: "sample-workbook-terminal-growth",
    terminalGrowthOverrideReason: "",
    terminalGrowthDownside: formatRateInputNumber(-0.06200163015727912),
    terminalGrowthUpside: formatRateInputNumber(0.03),
    revenueGrowth: formatRateInputNumber(sampleCase.revenueGrowth),
    wacc: "",
    waccSource: "sample-workbook-discount-rate",
    waccOverrideReason: "",
    waccRiskFreeRate: formatRateInputNumber(0.064795),
    waccBeta: formatRateInputNumber(1.09),
    waccEquityRiskPremium: formatRateInputNumber(0.0738),
    waccRatingBasedDefaultSpread: formatRateInputNumber(0.0207),
    waccCountryRiskPremium: formatRateInputNumber(-0.0207),
    waccSpecificRiskPremium: formatRateInputNumber(0),
    waccPreTaxCostOfDebt: "",
    waccBankPerseroInvestmentLoanRate: formatRateInputNumber(0.0941),
    waccBankPemdaInvestmentLoanRate: formatRateInputNumber(0.0906),
    waccBankSwastaInvestmentLoanRate: formatRateInputNumber(0.0823),
    waccBankAsingInvestmentLoanRate: formatRateInputNumber(0.0851),
    waccBankCampuranInvestmentLoanRate: formatRateInputNumber(0.0881),
    waccBankUmumInvestmentLoanRate: "",
    waccDebtWeight: formatRateInputNumber(0.17722560473918053),
    waccEquityWeight: formatRateInputNumber(0.8227743952608195),
    waccDebtMarketValue: "",
    waccEquityMarketValue: "",
    waccComparable1Name: "",
    waccComparable1BetaLevered: "",
    ...
    waccComparable3MarketCap: "",
    waccComparable3Debt: "",
    requiredReturnOnNta: formatRateInputNumber(sampleCase.requiredReturnOnNta),
