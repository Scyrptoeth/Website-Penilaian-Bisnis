...
export const accountMappingRules: AccountMappingRule[] = [
  {
    ...
    treatment: "review",
    valuationImpact: ["AAM"],
    reviewNote: "Gunakan sebagai override total aset hanya jika rincian komponen aset tidak tersedia atau sudah direkonsiliasi.",
  },
  {
    category: "CURRENT_ASSET",
    displayName: "Aset lancar",
    aliases: [
      "current asset",
      "current assets",
      "aset lancar",
    ...
    reviewNote: "Petakan ke kategori aset lancar yang lebih rinci jika subledger tersedia; prepaid dan contract asset perlu tinjauan operating WC.",
  },
  {
    category: "CASH_ON_HAND",
    displayName: "Kas di tangan",
    ...
    reviewNote: "Kas di tangan dapat menjadi operating cash; tinjau minimum operating cash sebelum seluruhnya diperlakukan sebagai surplus.",
  },
  {
    category: "CASH_ON_BANK",
    displayName: "Bank dan deposito",
    aliases: [
      "cash on bank",
      "cash at bank",
    ...
    reviewNote: "Pisahkan rekening bank operasional dari deposito/investasi jika subledger tersedia.",
  },
  {
    category: "EXCESS_CASH",
    displayName: "Kas berlebih",
    ...
    reviewNote: "Perlakukan sebagai non-operasional hanya setelah minimum operating cash dipertimbangkan.",
  },
  {
    category: "SURPLUS_ASSET_CASH",
    displayName: "Kas aset surplus",
    ...
    reviewNote: "Aset surplus mirip kas ditambahkan pada EV-to-equity bridge setelah tinjauan operating cash.",
  },
  {
    category: "MARKETABLE_SECURITIES",
    displayName: "Surat berharga",
    aliases: [
    ...
    reviewNote: "Umumnya non-operasional kecuali dibutuhkan untuk operasi normal.",
  },
  {
    category: "OTHER_RECEIVABLE",
    displayName: "Piutang lain-lain",
    aliases: [
      "other receivable",
      "other receivables",
    ...
    excludeKeywords: ["account receivable", "accounts receivable", "trade receivable", "piutang usaha", "piutang dagang"],
    treatment: "non_operating",
    valuationImpact: ["AAM", "non-operating asset bridge", "DCF balance-sheet projection"],
    reviewNote: "Piutang non-dagang tidak masuk operating working capital; bawa saldo historis sampai ada driver atau kebijakan khusus.",
  },
  {
    category: "ACCOUNT_RECEIVABLE",
    displayName: "Piutang usaha",
    aliases: [
      "account receivable",
      "accounts receivable",
      "piutang usaha",
    ...
    reviewNote: "Aset lancar operasional kecuali bukti menunjukkan piutang non-operasional.",
  },
  {
    category: "EMPLOYEE_RECEIVABLE",
    displayName: "Piutang karyawan / pihak berelasi",
    aliases: [
      "employee receivable",
      "piutang karyawan",
      "piutang pegawai",
    ...
    reviewNote: "Umumnya dikeluarkan dari operating working capital dan ditambahkan sebagai aset non-operasional.",
  },
  {
    category: "INVENTORY",
    displayName: "Persediaan",
    aliases: [
      "inventory",
      "inventories",
      "persediaan",
    ...
    treatment: "operating",
    valuationImpact: ["AAM", "working capital", "DCF WC days"],
    reviewNote: "Aset lancar operasional untuk working capital kecuali ada bukti usang/non-operasional.",
  },
  {
    category: "FIXED_ASSET",
    displayName: "Aset tetap",
    aliases: [
      "fixed asset",
      "fixed assets",
    ...
    reviewNote: "Perlakukan sebagai operasional kecuali ada bukti idle atau aset tetap non-operasional.",
  },
  {
    category: "NON_OPERATING_FIXED_ASSETS",
    displayName: "Aset tetap non-operasional",
    aliases: [
    ...
    treatment: "non_operating",
    valuationImpact: ["AAM", "EEM bridge", "DCF bridge"],
    reviewNote: "Tambahkan di luar operating NTA jika aset idle atau tidak diperlukan untuk earning power.",
  },
  {
    category: "FIXED_ASSET_ACQUISITION",
    displayName: "Harga perolehan aset tetap",
    ...
    reviewNote: "Gunakan bersama akumulasi penyusutan untuk menurunkan nilai buku aset tetap jika nilai neto tidak tersedia.",
  },
  {
    category: "ACCUMULATED_DEPRECIATION",
    displayName: "Akumulasi penyusutan",
    ...
    reviewNote: "Kurangkan dari biaya perolehan jika nilai buku aset tetap tidak tersedia langsung.",
  },
  {
    category: "DEPRECIATION_EXPENSE",
    displayName: "Beban penyusutan",
    ...
    reviewNote: "Beban nonkas operasional untuk EBIT dan proxy maintenance capex DCF.",
  },
  {
    category: "INTANGIBLE_ASSETS",
    displayName: "Aset tak berwujud",
    aliases: [
      "intangible assets",
      "aset tak berwujud",
      "aktiva tak berwujud",
    ...
    reviewNote: "Akui untuk AAM, tetapi tinjau pengecualian dari basis aset berwujud operasional untuk EEM.",
  },
  {
    category: "NON_CURRENT_ASSET",
    displayName: "Aset tidak lancar",
    aliases: [
      "non current asset",
      "non current assets",
      "non-current asset",
    ...
    reviewNote: "Kategori aset tidak lancar umum; tentukan operasional, surplus, atau aset yang dikecualikan berdasarkan substansi dan bukti penggunaan.",
  },
  {
    category: "TOTAL_LIABILITIES",
    displayName: "Total liabilitas",
  ...
  },
  {
    ...
    displayName: "Pinjaman bank jangka pendek",
    aliases: [
  ...
  },
  {
    ...
    displayName: "Pinjaman bank jangka panjang",
    aliases: [
      "bank loan long term",
      "long term bank loan",
  ...
  },
  {
    ...
    reviewNote: "Saldo pendanaan setara utang; keluarkan dari operating working capital.",
  },
  {
    category: "NON_CURRENT_LIABILITIES",
    displayName: "Liabilitas tidak lancar",
    aliases: [
  ...
  },
  {
    ...
    reviewNote: "Komponen ekuitas untuk rekonsiliasi; jangan gunakan sebagai item enterprise-to-equity bridge.",
  },
  {
    ...
    treatment: "equity",
    valuationImpact: ["balance sheet check", "equity roll-forward"],
    reviewNote: "Komponen ekuitas; perlakuan arus kas sebaiknya memakai mutasi periode, bukan saldo akhir.",
  },
  {
    category: "RETAINED_EARNINGS_SURPLUS",
    displayName: "Saldo laba ditahan",
    ...
    reviewNote: "Akun rekonsiliasi ekuitas; bukan driver earning power operasional.",
  },
  {
    category: "RETAINED_EARNINGS_CURRENT_PROFIT",
    displayName: "Laba tahun berjalan di neraca",
    ...
    reviewNote: "Tinjau basis komersial versus fiskal sebelum digunakan sebagai earning power.",
  },
  {
    category: "REVENUE",
    displayName: "Pendapatan usaha",
    aliases: [
      "revenue",
      "sales",
      "net sales",
    ...
    reviewNote: "Gunakan revenue komersial sebagai driver operasional.",
  },
  {
    category: "COST_OF_GOOD_SOLD",
    displayName: "Beban pokok penjualan",
    aliases: [
      "cost of good sold",
      "cost of goods sold",
      "cost of revenue",
    ...
    reviewNote: "Biaya operasional; pertahankan konvensi tanda secara konsisten.",
  },
  {
    category: "SELLING_EXPENSE",
    displayName: "Beban penjualan",
    aliases: [
      "selling expense",
      "sales expense",
    ...
    treatment: "operating",
    valuationImpact: ["EBIT", "DCF margin"],
    reviewNote: "Beban operasional; pertahankan konvensi tanda secara konsisten.",
  },
  {
    category: "GENERAL_ADMINISTRATIVE_OVERHEADS",
    displayName: "Beban umum dan administrasi",
    aliases: [
    ...
    treatment: "operating",
    valuationImpact: ["EBIT", "DCF margin"],
    reviewNote: "Beban operasional yang mengecualikan item pendanaan dan non-operasional.",
  },
  {
    category: "OPERATING_EXPENSE",
    displayName: "Beban operasional",
    aliases: [
      "operating expense",
      "operating expenses",
      "opex",
    ...
    treatment: "operating",
    valuationImpact: ["EBIT", "DCF margin"],
    reviewNote: "Kategori beban operasional umum; gunakan kategori penjualan atau G&A yang lebih spesifik jika tersedia.",
  },
  {
    category: "EBIT",
    displayName: "EBIT",
    ...
    reviewNote: "Gunakan EBIT komersial sebagai override ketika komponen laba rugi tidak lengkap.",
  },
  {
    category: "COMMERCIAL_NPAT",
    displayName: "NPAT komersial",
    aliases: [
    ...
    reviewNote: "Gunakan laba komersial saja; jangan gunakan rekonsiliasi fiskal sebagai earning power.",
  },
  {
    category: "CORPORATE_TAX",
    displayName: "Pajak penghasilan badan",
    aliases: [
      "corporate tax",
  ...
  },
  {
    ...
    reviewNote: "Keluarkan dari NOPLAT operasional; dapat mendukung deposito sebagai aset surplus.",
  },
  {
    category: "INTEREST_EXPENSE",
    displayName: "Beban bunga",
    aliases: [
      "interest expense",
      "finance cost",
      "finance costs",
    ...
    reviewNote: "Keluarkan dari NOPLAT operasional dan tinjau apakah utang terkait tersedia.",
  },
  {
    category: "NON_OPERATING_INCOME",
    displayName: "Pendapatan/beban non-operasional",
    aliases: [
    ...
    reviewNote: "Keluarkan dari earning power operasional.",
  },
  {
    category: "WORKING_CAPITAL",
    displayName: "Dukungan working capital",
    ...
    reviewNote: "Gunakan sebagai dukungan/review; model tetap mengutamakan AR, persediaan, AP, dan utang lain-lain sebagai driver WC.",
  },
  {
    category: "CASH_FLOW_FROM_OPERATIONS",
    displayName: "Arus kas dari operasi",
    aliases: [
    ...
    reviewNote: "Gunakan sebagai dukungan bridge; FCFF tetap dihitung dari EBIT, NOPLAT, dan operating WC.",
  },
  {
    category: "CASH_FLOW_FROM_FINANCING",
    displayName: "Arus kas dari pendanaan",
    aliases: [
    ...
    reviewNote: "Gunakan untuk meninjau mutasi utang/ekuitas; bukan driver operating FCFF langsung.",
  },
  {
    category: "CASH_FLOW_FROM_NON_OPERATIONS",
    displayName: "Arus kas non-operasional",
    aliases: [
    ...
    reviewNote: "Gunakan untuk meninjau capex, investasi, dan pelepasan aset; klasifikasi ulang jika merupakan dukungan capex operasional.",
  },
  {
    category: "CASH_FLOW_AVAILABLE_TO_INVESTOR",
    displayName: "Arus kas tersedia untuk investor",
    aliases: [
    ...
    reviewNote: "Gunakan sebagai dukungan/rekonsiliasi terhadap FCFF hasil kalkulasi model.",
  },
];
...
export function mapAccount(sourceLabel: string, statement?: StatementContext): AccountMappingResult {
  ...
  if (!best || !best.lexicalMatch || confidence === 0) {
    return {
      ...
      treatment: "review",
      valuationImpact: ["mapping review"],
      reason: "Tidak ada alias atau kata kunci yang cocok. Tinjauan kategori manual diperlukan.",
      needsReview: true,
      matchedKeywords: [],
      excludedKeywords: [],
      statementCompatible: statement ? false : null,
  ...
  return {
    ...
    reason: `${best.exactAliasHit ? "Alias persis cocok" : best.aliasHit ? "Alias cocok" : "Kata kunci cocok"} dengan ${best.includeHits} kata kunci.${
      ambiguousMatch ? ` Kandidat lain dekat: ${runnerUp?.rule.displayName}.` : ""
    } ${best.excluded ? `Kata kunci dikecualikan: ${best.excludedKeywords.join(", ")}. ` : ""}${rule.reviewNote}`,
