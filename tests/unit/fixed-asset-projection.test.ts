...
function forecastRow(patch: Partial<DcfForecastRow> & { year: number }): DcfForecastRow {
  ...
  return {
    ...
    accountingTaxOnPbt: 0,
    accountingNetProfitAfterTax: 0,
    noplatBridgeInterestExpenseAddBack: 0,
    noplatBridgeInterestIncomeDeduction: 0,
    noplatBridgeNonOperatingIncomeDeduction: 0,
    noplatBridgeOperatingEbit: 0,
    noplatBridgeTaxOnEbit: 0,
    noplatBridgeNoplat: 0,
    cashOnHand: 0,
    cashOnBankDeposit: 0,
    accountReceivable: 0,
    ...
    currentAssets: 0,
    operatingCurrentAssetsBeginning: 0,
    ...
    operatingCurrentLiabilitiesBeginning: 0,
    ...
    totalAssets: 0,
    bankLoanLongTerm: 0,
    debtBeginningBalance: 0,
    debtEndingBalance: 0,
    debtBalanceSheetMovement: 0,
    debtDrawdownFromBalanceSheet: 0,
    debtRepaymentFromBalanceSheet: 0,
    otherNonCurrentLiabilities: 0,
    nonCurrentLiabilities: 0,
    paidUpCapital: 0,
    additionalPaidInCapital: 0,
    shareholdersEquityBeginning: 0,
    shareholdersEquityMovement: 0,
    ...
    balanceControl: 0,
    taxPayableBeginning: 0,
    taxExpenseAccrued: 0,
    taxCashPaidImpliedByPayableSchedule: 0,
    taxPayableScheduleControl: 0,
    cashTaxVarianceToSchedule: 0,
    cashPolicyTarget: 0,
    cashPolicyGap: 0,
    cashPolicySurplus: 0,
    cashPolicyFundingNeed: 0,
    ...
    scheduledDividendDistribution: 0,
    unallocatedFinancingCashFlow: 0,
    unallocatedFinancingInflow: 0,
    unallocatedFinancingOutflow: 0,
    financingScheduleControl: 0,
