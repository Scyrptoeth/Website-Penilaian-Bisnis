...
const assumptionLabels: Record<keyof AssumptionState, string> = {
  ...
  waccBankPemdaInvestmentLoanRate: "SBDK investasi bank pemda",
  waccBankSwastaInvestmentLoanRate: "SBDK investasi bank swasta",
  waccBankAsingInvestmentLoanRate: "SBDK investasi bank asing",
  waccBankCampuranInvestmentLoanRate: "SBDK investasi bank campuran",
...
function buildDcfSheet(input: ValuationExcelExportInput, snapshotRefs: SheetRefs) {
  ...
  rows.push(["DCF projection governance active value", numberCell(input.results.projectionGovernance.governedEquityValue, "currency"), input.results.projectionGovernance.title]);
  rows.push(["DCF projection governance variance", numberCell(input.results.projectionGovernance.relativeVariance, "percent"), input.results.projectionGovernance.summary]);
