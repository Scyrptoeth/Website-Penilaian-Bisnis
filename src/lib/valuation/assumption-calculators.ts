...
export function buildRequiredReturnOnNtaSuggestion({
  ...
  const fields: RequiredReturnOnNtaSuggestion["fields"] = {
    ...
    requiredReturnFixedAssetCapacity: {
      ...
      source: "Dihitung dari Aset Tetap aktif, struktur BORROWING CAP, dan referensi POJK agunan",
      basis: "Workbook memakai 70% atas aset tetap neto; POJK No. 40/POJK.03/2019 Pasal 48 dipakai sebagai proxy formal yang tetap perlu review kasus.",
