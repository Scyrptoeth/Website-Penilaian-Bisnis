...
const dcfCashFlowProjectionRows: DcfProjectionLine[] = [
  ...
  },
  {
    ...
    source: "Default non-operasional",
    formula: "0 sampai ada driver non-operasional eksplisit",
    status: "review",
    workbookReference: "CF-NONOPS-01",
    value: (row) => row.nonOperatingCashFlow,
    note: "Tidak mengubah FCFF operasi; perlu jadwal terpisah bila ada arus kas non-operasional material.",
  },
  {
    key: "capital-expenditure",
  ...
  sectionProjectionLine("financing-section", "Financing"),
  {
    ...
    source: "Jadwal modal konstan",
    formula: "0 sampai ada aksi korporasi/setoran modal baru",
    status: "review",
  ...
  },
  {
    ...
    source: "Plug integrasi pendanaan",
    formula: "max(Cash flow from financing, 0)",
    status: "review",
  ...
  },
  {
    key: "interest-expense",
    label: "Interest Expense",
    source: "Default financing cash flow",
    formula: "0; interest expense tidak masuk FCFF operasi",
    status: "review",
    workbookReference: "CF-FIN-03",
    value: (row) => row.interestExpenseCashFlow,
    note: "Butuh debt schedule untuk mengubah baris ini dari default review menjadi calculated.",
  },
  {
    key: "interest-income",
    label: "Interest Income",
    source: "Default financing/non-operating cash flow",
    formula: "0 sampai ada kebijakan kas/deposito eksplisit",
    status: "review",
  ...
  },
  {
    ...
    source: "Plug pendanaan tersirat",
    formula: "min(Cash flow from financing, 0)",
    status: "review",
  ...
  },
  {
    ...
    source: "Rekonsiliasi kas dan neraca",
    formula: "Ending cash - beginning cash - cash flow before financing",
    status: "review",
    workbookReference: "CF-FIN-06",
    value: (row) => row.cashFlowFromFinancing,
    kind: "subtotal",
    note: "Baris ini mempertahankan neraca proyeksi yang sudah balance sambil membuat kebutuhan pendanaan/distribusi tersirat menjadi transparan.",
  },
  {
    key: "net-cash-flow",
    label: "Net Cash Flow",
