...
export interface DcfForecastRow {
  ...
  totalAssets: number;
  bankLoanLongTerm: number;
  debtBeginningBalance: number;
  debtEndingBalance: number;
  debtBalanceSheetMovement: number;
  debtDrawdownFromBalanceSheet: number;
  debtRepaymentFromBalanceSheet: number;
  otherNonCurrentLiabilities: number;
  nonCurrentLiabilities: number;
  paidUpCapital: number;
  additionalPaidInCapital: number;
  shareholdersEquityBeginning: number;
  shareholdersEquityMovement: number;
  retainedEarningsSurplus: number;
  ...
  taxPayableBeginning: number;
  taxExpenseAccrued: number;
  taxCashPaidImpliedByPayableSchedule: number;
  taxPayableScheduleControl: number;
  cashTaxVarianceToSchedule: number;
  cashPolicyTarget: number;
  cashPolicyGap: number;
  cashPolicySurplus: number;
  cashPolicyFundingNeed: number;
  ...
  newLoan: number;
  interestExpenseCashFlow: number;
  interestIncomeCashFlow: number;
  principalRepayment: number;
  scheduledDividendDistribution: number;
  unallocatedFinancingCashFlow: number;
  unallocatedFinancingInflow: number;
  unallocatedFinancingOutflow: number;
  financingScheduleControl: number;
  cashFlowFromFinancing: number;
  netCashFlow: number;
  cashEndingBalance: number;
  cashFlowControl: number;
